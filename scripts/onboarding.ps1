...
if (Test-DockerServiceRunning 'multica-postgres') { Write-Good 'Postgres container is running' } else { Write-Warn 'Postgres container is not running' }
...
Write-Host '  3) Build Multica if needed according to repo docs' -ForegroundColor White
